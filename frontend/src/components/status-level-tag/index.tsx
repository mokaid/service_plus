...
import { ALARM_LEVEL_NAME_MAP, Status_LEVEL_NAME_MAP } from "@/const/alarm";
...
export const StatusLevelTag: FC<Props> = ({ className, level }) => {
  ...
  return (
    ...
    >
      {Status_LEVEL_NAME_MAP[alarmLevelName]}
    </Tag>
  );
};
